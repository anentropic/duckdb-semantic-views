.. meta::
   :description: Complete SQL syntax reference for all CREATE, ALTER, DROP, DESCRIBE, SHOW, and query function statements
...
- :ref:`ref-alter-semantic-view` — Rename an existing semantic view.
