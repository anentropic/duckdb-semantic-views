...
/// Helper: declare the 8-column output schema for dimensions.
...
/// C++ Catalog API path (`sv_register_show_semantic_dimensions_all`).
/// Struct kept under `#[allow(dead_code)]` until the cleanup commit.
#[allow(dead_code)]
