...
- YAML definition format — ✓ Now active in v0.7.0 (Phase 51-52: parser core + DDL integration)
...
**Codebase:** ~29,000 LOC Rust across src/ and tests/. 819 Rust tests + 36 sqllogictest files + 6 DuckLake CI tests + Python crash repro + Python caret tests + 5 fuzz targets.
...
Last updated: 2026-04-21 (Phase 57 complete — v0.7.0 milestone all phases done)
