...
**Codebase:** ~28,000 LOC Rust across src/ and tests/. 807 Rust tests + 35 sqllogictest files + 6 DuckLake CI tests + Python crash repro + Python caret tests + 5 fuzz targets.
