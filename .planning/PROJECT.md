...
**Codebase:** ~27,400 LOC Rust across src/ and tests/. 796 Rust tests + 34 sqllogictest files + 6 DuckLake CI tests + Python crash repro + Python caret tests + 5 fuzz targets.
