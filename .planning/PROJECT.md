...
**Codebase:** ~26,600 LOC Rust across src/ and tests/. 740 Rust tests + 31 sqllogictest files + 6 DuckLake CI tests + Python crash repro + Python caret tests + 5 fuzz targets.
