...
- [ ] **YAML-03**: YAML schema supports all SemanticViewDefinition fields: tables, relationships, dimensions, metrics, facts, and metadata annotations (COMMENT, SYNONYMS, PRIVATE/PUBLIC)
...
- [ ] **YAML-05**: YAML and SQL DDL produce identical internal representations — same validation, persistence, and query behavior
...
- [ ] **YAML-09**: YAML input is size-capped to prevent anchor/alias bomb denial-of-service
