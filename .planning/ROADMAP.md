...
**Plans:** 1/1 plans complete
Plans:
- [x] 55-01-PLAN.md -- try_route_materialization() pure function, expand() early-exit integration, with_materialization() test builder, unit tests, sqllogictest integration tests
