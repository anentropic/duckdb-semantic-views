...
Plans:
- [ ] 67-01-PLAN.md — Expansion-SQL shape coverage (A1+A2+A3+A4): new phase67_qualified_emission.test fixture + shape assertions added to phase46/47/48
...
- [ ] 67-03-PLAN.md — Phase 66 review-pass cleanup batch (C1+C2+C3): WR-02 reclassification + WR-01 sentinel-keep rationale + IN-02 FORCE INSTALL hardening
